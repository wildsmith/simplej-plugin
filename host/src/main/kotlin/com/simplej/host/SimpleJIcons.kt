 ...
 * Icons are loaded lazily using IntelliJ's [IconLoader] and cached for reuse.
 * All icons should be placed in the `/icons/expui/` resources directory as SVG files.
 */
object SimpleJIcons {

    /**
     * Icon representing an Android device.
     *
     * Used in UI elements related to Android device operations.
     * The icon is loaded from `/icons/expui/androidDevice.svg`.
     */
    @JvmField
     ...
     * @throws [com.intellij.openapi.util.IconLoadingException] if the icon cannot be found or loaded
     */
