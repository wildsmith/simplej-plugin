 ...
 *
 * This extension property is useful for actions that operate on multiple selected files,
 * such as bulk operations in the Project view or other file-centric contexts.
 *
 ...
 *
 * This extension function bridges the gap between Java IO and IntelliJ's virtual file system,
 * allowing easy conversion from standard Java files to IntelliJ's virtual file representation.
 *
 ...
 *
 * This function searches upwards through the file hierarchy to find the nearest
 * directory that contains a 'build.gradle.kts' file, indicating a Gradle project root.
 * If multiple project roots are found, it returns the one with the longest path that
