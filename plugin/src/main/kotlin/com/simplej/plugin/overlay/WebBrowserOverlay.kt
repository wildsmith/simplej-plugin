...
/**
 * Web browser overlay component that displays a collapsible, resizable mini browser
 * in the bottom right corner of the editor.
 */
class WebBrowserOverlay(
    ...
    private fun openInExternalBrowser() {
        try {
            ...
            // Show message here if copied?
        }
    }

    /**
     * Long text will cause ui issues mortal eyes shouldnt see
      */
